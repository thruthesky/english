...
export class CommentComponent {
    ...
    students: Array<{
        ...
        { name:"김민지", src:"assets/images/comment/comment3.png", comment:"저는 6살때 부터 굿톡을 했는데 지금은 초등학교 2학년이에요. 삼육 학원에서 고등학생과 같이 수업을 해요. 한국말하는 것 처럼 영어를 자연스럽게 할 수 있어요. Briana 선생님 덕분이죠." },
